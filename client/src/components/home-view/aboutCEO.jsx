...
import img from "../../assets/our_ceo.jpg"
          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-gray-600 text-base md:text-xl leading-relaxed mb-4 text-justify'>
                I’m Abiramee Ravi, a Biomedical Engineer and Assistant Professor with a passion for merging nanotechnology, artificial intelligence, and biomedical instrumentation to improve healthcare technologies. With over 4 years of teaching and research experience, I have contributed to innovative biomedical projects and scholarly publications in the field of non-invasive diagnostics and smart sensing systems. 
              </p>
            </div>
